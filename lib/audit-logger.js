...
const LOG_DIR = process.env.AUDIT_LOG_DIR || process.env.REPORTS_DIR || path.resolve(process.cwd(), "data", "logs");
...
try {
  ...
  console.warn(`[Audit] Cannot create log dir ${LOG_DIR}: ${err.message}. Falling back to stdout only.`);
}
