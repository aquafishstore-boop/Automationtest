...
const TRAINING_DIR = process.env.TRAINING_DATA_DIR || path.resolve(process.cwd(), "data", "runs", "training");
...
try {
  ...
  console.warn(`[FineTuner] Cannot create training dir ${TRAINING_DIR}: ${err.message}. Training data collection disabled.`);
}
